...
Command: npx gltfjsx@6.2.16 ../../../public/computer_grass/scene.gltf 
...
const GreenComputer = (props) => {
	const group = useRef();
	const { nodes, materials, animations } = useGLTF(
		"/computer_grass/scene.gltf"
	);
...
export default GreenComputer;

useGLTF.preload("/computer_grass/scene.gltf");
